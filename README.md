...
<h3 align="center">B.Tech 3rd year Student  | ML Intern @ DRDO-SSPL | DS Intern @ Axlero Solutions | Tech Enthusiast from MAIT-Delhi</h3>
...
### 🔧 Tools & Platforms
`Git` • `GitHub` • `VS Code` • `Intellij Idea` • `Anaconda` • `Vercel` • `Postman` • `Jupyter` • `Google Collab`

### 📊 Data & AI/ML
`NumPy` • `pandas` • `Matplotlib` • `Scikit-learn` • `Pytorch` • `Tensorflow` • `Seaborn` • `Langchain` • `Langgraph` • `Pydantic`  
